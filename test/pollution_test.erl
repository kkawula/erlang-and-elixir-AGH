...
get_area_mean_test() ->
  M = pollution:add_station("Stacja 3", {30,30}, pollution:add_station("Stacja 2", {2,2}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor()))),
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 2, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 6, M1),
  M3 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,12}}, "PM10", 2, M2),
  M4 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,13}}, "PM10", 6, M3),

  M5 = pollution:add_value("Stacja 3", {{2023,3,27},{11,16,18}}, "PM10", 9, M4),
  M6 = pollution:add_value("Stacja 3", {{2023,3,27},{11,16,19}}, "PM25", 13, M5),


  ?assertMatch(2.0, pollution:get_area_mean("PM10", {1,1}, 1, M6)),
  ?assertMatch(4.0, pollution:get_area_mean("PM10", {1,1}, 5, M6)),
  ?assertMatch(5.0, pollution:get_area_mean("PM10", {1,1}, 50, M6)).
