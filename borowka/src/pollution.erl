...
%% API
-export([crash/0, create_monitor/0, add_station/3, add_value/5, remove_value/4, get_one_value/4, get_station_mean/3, get_daily_mean/3, does_point_fit_in_radius/3, get_area_mean/4]).
